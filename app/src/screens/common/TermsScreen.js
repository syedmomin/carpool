...
const SECTIONS = [
  { title: '1. Acceptance of Terms', body: 'By using SafariShare, you agree to these terms. If you do not agree, please do not use the app.' },
  ...
  { title: '4. Payments', body: 'All payments are made in cash directly between passengers and drivers. SafariShare does not handle payments.' },
  { title: '5. Safety', body: 'All drivers must have a valid CNIC and driving license. SafariShare reserves the right to remove unsafe drivers.' },
  { title: '6. Privacy', body: 'We collect minimal data to provide our services. Your data is never sold to third parties.' },
  { title: '7. Limitation of Liability', body: 'SafariShare is a platform connecting drivers and passengers. We are not liable for any incidents during rides.' },
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        <Text style={styles.intro}>Please read these terms carefully before using SafariShare.</Text>
        {SECTIONS.map((s, i) => (
